...
<html>
  <head>
	...
	<script language="javascript" src="<%=basePath%>user/images/article.js"></script>
  </head>
  ...
  <body>
  	...
  	<div id="xjwz">
	    ...
	    <form action="addArticle" method="post" class="form1">
	    	...
	    	<textarea name="content" class="xheditor {width:'500',height:'300'}" id="contentval"></textarea><br/>
	    	<div class="btns">
